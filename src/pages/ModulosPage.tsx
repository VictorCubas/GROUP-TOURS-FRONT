...
export default function ModulosPage() {
  ...
  const [moduloAEditar, setModuloAEditar] = useState<Modulo>();
  const [dataADesactivar, setDataADesactivar] = useState<Modulo>();
  const [onDesactivarData, setOnDesactivarData] = useState(false);
  const [onVerData, setOnVerData] = useState(false);
  const [dataDetalle, setDataDetalle] = useState<Modulo>();
  ...
  const {data, isFetching, isError} = useQuery({
    queryKey: ['modulos', currentPage, paginacion.pageSize, nombreABuscar, showActiveOnly], //data cached
  ...
  const {data: dataResumen, isFetching: isFetchingResumen, isError: isErrorResumen} = useQuery({
    queryKey: ['modulo-resumen'], //data cached
  ...
  const handleEditar = (data: Modulo) => {
    setActiveTab('form');
  ...
  const handleVerDetalles = (data: Modulo) => {
    setDataDetalle(data);
    setOnVerData(true);
  }
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-semibold text-gray-900">Modulos</h1>
              </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-emerald-700">
                          Complete la información para crear un nuevo módulo
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                ...
                <CardHeader className="bg-blue-50 border-b border-blue-200 pt-8">
                  <div className="flex items-center justify-between ">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-blue-900">Lista de Módulos</CardTitle>
                        <CardDescription className="text-blue-700">
                          Mostrando {startIndex + 1}-{Math.min(endIndex, totalItems)} de {totalItems} módulos
                        </CardDescription>
                      </div>
                    </div>
