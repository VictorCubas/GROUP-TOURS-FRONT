...
import { activarDesactivarData, fetchData, fetchResumen, guardarDataEditado, nuevoPermisoFetch } from "@/components/utils/httpTipoPaquetess"
...
export default function TipoPaquetePage() {
  ...
  const {data, isFetching, isError} = useQuery({
    queryKey: ['tipo-paquetes', currentPage, paginacion.pageSize, nombreABuscar, showActiveOnly], //data cached
  ...
  const {data: dataResumen, isFetching: isFetchingResumen, isError: isErrorResumen} = useQuery({
    queryKey: ['tipo-paquetes-resumen'], //data cached
  ...
  const {mutate, isPending: isPendingMutation} = useMutation({
    ...
    onSuccess: () => {
        handleShowToast('Se ha creado un nuevo tipo de paquete satisfactoriamente', 'success');
        reset({
            nombre: "",
            descripcion: "",
          });
        setActiveTab('list');
         ...
         queryClient.invalidateQueries({
          queryKey: ['tipo-paquetes'],
          exact: false
        });

        queryClient.invalidateQueries({
          queryKey: ['tipo-paquetes-resumen'],
        });
  ...
  const {mutate: mutateGuardarEditado, isPending: isPendingEdit} = useMutation({
    ...
    onSuccess: () => {
        handleShowToast('Se ha guardado el tipo de paquete satisfactoriamente', 'success');
  ...
  const {mutate: mutateDesactivar, isPending: isPendingDesactivar} = useMutation({
    ...
    onSuccess: () => {
        handleShowToast(`Se ha ${textActivarDesactivar} el tipo de paquete satisfactoriamente`, 'success');
                      ...
                      <div className="mb-6 border-b pb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">Detalles completos del tipo de paquete</p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="p-4 bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-lg">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="space-y-2">
                                <h4 className="font-semibold text-cyan-900">Información del Paquete</h4>
            ...
            <div className="modal-detalles-reserva bg-white/95 rounded-xl shadow-xl max-w-7xl w-full max-h-[95vh] overflow-y-auto backdrop-blur-sm">
              <Modal onClose={handleCloseModal} claseCss="modal">
                  ...
                  <p className=' text-gray-600 dark:text-gray-400 mt-2 text-justify'>
                      ¿Estás seguro de que deseas {dataADesactivar!.activo ? 'desactivar' : 'activar'} el tipo de paquete <b>{capitalizePrimeraLetra(dataADesactivar?.nombre ?? '')}</b>? 
                  </p>
      ...
      <div className="max-w-[95vw] mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* <div className="flex gap-3">
              ...
              */}
              ...
              {siTienePermiso('tipo_documentos', 'crear') &&
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2 lg:w-fit bg-gray-100">
              ...
              <TabsTrigger 
                disabled={!siTienePermiso('tipo_documentos', 'crear')}
                ...
                <Card className="border-emerald-200 pt-0">
                  <CardHeader className="bg-emerald-50 border-b border-emerald-200 pt-8">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-emerald-900">Crear Nuevo Tipo Paquete</CardTitle>
                        <CardDescription className="text-emerald-700">
                          Complete la información para crear un nuevo tipo de paquete
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          id="nombre"
                          autoComplete="nombre"
                          placeholder="Ejemplo: Terrestre, Aereo, Acuatico, etc"
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <Textarea
                          ...
                          placeholder="Información adicional sobre el tipo de paquete"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-blue-700">
                          Mostrando {startIndex + 1}-{Math.min(endIndex, totalItems)} de {totalItems} tipos de paquetes
                        </CardDescription>
                      </div>
                    </div>
                ...
                <CardContent className="p-0">
                  <Table>
                    ...
                    <TableBody className="w-full">
                      ...
                      {!isFetching && dataList.length > 0 && siTienePermiso('tipo_documentos', 'leer') && dataList.map((data: TipoDocumento) => (
                        <TableRow
                          key={data.id}
                          ...
                          <TableCell>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="border-gray-200">
                                {siTienePermiso('tipo_documentos', 'leer') &&
                                ...
                                {siTienePermiso('tipo_documentos', 'modificar') && 
                                ...
                                {siTienePermiso('tipo_documentos', 'eliminar') &&
                                  <>
                                    <DropdownMenuSeparator />
                        ...
                        <TableRow className="">
                          <TableCell className="w-full flex items-center justify-center">
                            <div className="text-center py-12  absolute-center">
                              ...
                              <h3 className="text-lg font-medium text-gray-900 mb-2">No se encontraron tipos de paquetes</h3>
