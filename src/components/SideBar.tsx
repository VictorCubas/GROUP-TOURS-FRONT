...
const sidebarItems = [
  ...
  { icon: Settings, label: "Configuración", href: "#", color: "text-slate-400" ,
      ...
      { label: "Tipos Documentos", href: "/configuracion/tipo_documentos", color: "text-pink-400", bgcolor: "bg-pink-400" },
      { label: "Nacionalidades", href: "/configuracion/nacionalidades", color: "text-yellow-400", bgcolor: "bg-yellow-400" },
      { label: "Tipos Habitaciones", href: "/configuracion/tipo_habitaciones", color: "text-blue-400", bgcolor: "bg-blue-400" },
      { label: "Tipos Paquetes", href: "/configuracion/tipo_paquetes", color: "text-emerald-400", bgcolor: "bg-emerald-400" },
